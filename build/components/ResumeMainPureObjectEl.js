export const ResumeMainPureObjectEl = (host, insertPosition, props) => {
    ...
    if (hasInnerObject) {
        Object.entries(info).forEach((el) => ResumeMainPureObjectEl(document.querySelector(`.resume-main-${el[0].replace(/ /g, "")}`), "afterbegin", { name: el[0], info: el[1] }));
    }
};
//# sourceMappingURL=ResumeMainPureObjectEl.js.map